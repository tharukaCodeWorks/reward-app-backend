...
trait VerifiesUsers
{
    ...
    public function getVerification(Request $request, $token)
    {
        if (! $this->validateRequest($request)) {
            return ApiWrapper::wrapApiResponse(['Your request not validated'], 'verify-error', 200);
        ...
        try {
            ...
            return ApiWrapper::wrapApiResponse(['Verfying user not found'], 'verify-error', 200);
            //return redirect($this->redirectIfVerificationFails());
        } catch (UserIsVerifiedException $e) {
            return ApiWrapper::wrapApiResponse(['User already verified'], 'verify-error', 200);
            //return redirect($this->redirectIfVerified());
        } catch (TokenMismatchException $e) {
            return ApiWrapper::wrapApiResponse(['User verification failed'], 'verify-error', 200);
            //return redirect($this->redirectIfVerificationFails());
        }
        ...
        return ApiWrapper::wrapApiResponse(['User successfully verified'], 'verified', 200);
    }
